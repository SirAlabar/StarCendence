    ...
    render(): string
    {
        return `
            <div class="container mx-auto px-6 py-12 text-center">
                ...
                <!-- Pong Game Card -->
                <div class="game-card pong-card rounded-3xl p-10 border border-gray-600 transition-all group flex flex-col">
                    <!-- Video Container -->
                    <div class="aspect-video bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-2xl overflow-hidden mb-8 relative">
                        <video 
                            ...
                            preload="metadata"
                        >
                            <source src="assets/images/demo_pong.mp4" type="video/mp4">
                            <!-- Fallback -->
