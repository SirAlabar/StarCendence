...
export class LoginService 
{
  ...
  static async login(credentials: LoginRequest): Promise<LoginResponse> 
  {
    try 
    {
      const response = await fetch(`${API.AUTH_BASE_URL}/login`, 
      {
        method: 'POST',
        headers: 
        {
  ...
  static async refreshToken(): Promise<RefreshResponse> 
  {
    ...
    try 
    {
      const response = await fetch(`${API.AUTH_BASE_URL}/refresh`, 
      {
        method: 'POST',
        headers: 
        {
  ...
  static async logout(): Promise<void> 
  {
    ...
    try 
    {
      await fetch(`${API.AUTH_BASE_URL}/logout`, 
      {
        method: 'POST',
        headers: 
        {
  ...
  static async logoutAllDevices(userId: string): Promise<void> 
  {
    try 
    {
      await fetch(`${API.AUTH_BASE_URL}/logout-all`, 
      {
        method: 'POST',
        headers: 
        {
  ...
  static async verifyToken(): Promise<VerifyResponse> 
  {
    ...
    try 
    {
      const response = await fetch(`${API.AUTH_BASE_URL}/verify`, 
      {
        method: 'GET',
        headers: 
        {
