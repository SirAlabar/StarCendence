            ...
            <div class="relative group">
                ${avatarUrl
                    ? `<img 
                        src="${avatarUrl}" 
                        alt="Avatar" 
                        class="w-48 h-48 rounded-full mx-auto object-cover border-4 border-cyan-500/50"
                    >`
                    : `<div class="w-48 h-48 rounded-full mx-auto flex items-center justify-center bg-gradient-to-br from-cyan-500 to-purple-600 border-4 border-cyan-500/50">
                        <svg class="w-28 h-28 text-cyan-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/70 rounded-full cursor-pointer" id="avatar-upload-trigger">
